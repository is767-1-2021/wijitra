...
class _AddCustomExerciseState extends State<AddCustomExercise> {
  ...
  void saveExercise() {
    ...
    customExercise.totalTimeInHours =
        (customExercise.totalTimeInMinutes ~/ 60).toInt();
    customExercise.caloriesPerMinute =
        customExercise.exerciseKCalPerHour / customExercise.totalTimeInMinutes;
    customExercise.userTimeMinutesSelected = totalMinutes;
    customExercise.userTimeSelected = (timeUser!.minute > 0)
        ? "${timeUser!.hour}:${timeUser!.minute}"
        : "${timeUser!.hour}";
    customExercise.userTimeBasedCalories =
        (customExercise.userTimeMinutesSelected *
                customExercise.caloriesPerMinute)
            .toInt();
    AppController().addExercise(customExercise.exerciseId,
        customExercise.exerciseName, customExercise.caloriesPerMinute);
