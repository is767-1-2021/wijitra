...
import 'package:todo_app_firestore_example/ming/screens/add_custom_exercise/add_custom_exercise.dart';
import 'package:todo_app_firestore_example/ming/services/app_controller.dart';
...
class SelectExercise extends StatefulWidget {
  ...
  SelectExercise(
      {this.selectedDateText, this.selectedDate, this.selectedDayExerciseList});
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return selectedExerciseCell(
                                widget.selectedDayExerciseList[index]);
                          })),
                )
              ],
            )),
